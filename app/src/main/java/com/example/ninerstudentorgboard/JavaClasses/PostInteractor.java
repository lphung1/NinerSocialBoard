...
//        DownloadManager.Query postsQuery;
//        if (date == 0) {
//            postsQuery = databaseReference.limitToLast(SyncStateContract.Constants.Post.POST_AMOUNT_ON_PAGE).orderByChild("createdDate");
//        } else {
//            postsQuery = databaseReference.limitToLast(SyncStateContract.Constants.Post.POST_AMOUNT_ON_PAGE).endAt(date).orderByChild("createdDate");
//        }
//
...
//    }
//
//    private DownloadManager.Query getSearchQuery(DatabaseReference databaseReference, String childOrderBy, String searchText) {
...
//    }
//
//    private DownloadManager.Query getFilteredQuery(DatabaseReference databaseReference, String childOrderBy, int limit) {
//        return databaseReference
//                .orderByChild(childOrderBy)
//                .limitToLast(limit);
//    }
